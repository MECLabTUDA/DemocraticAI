...
class ASMR(object):
    def __init__(self, exclude_vars: Optional[str] = None, weigh_by_local_iter: bool = True, apply_homomorphic_encryption:bool = False):
    ...
    def add(self, fl_model):
        ...
        with self.lock:
            ...
            self.client_updates.append(ClientUpdate(fl_model, client_name, vectorized=True, encrypted=self.apply_homomorphic_encryption, 
